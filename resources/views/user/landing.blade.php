        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <button class="btn text-white" type="button" class="btn btn-warning" data-toggle="modal"
    ...
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            <form action="#" mothod="POST">
                ...
                <button type="" class="btn btn-custom mt-2">Send</button>
            </form>
        </div>
    </div>
</div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">by M.Galih RI</p>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h3 class="mt-3">Login Fisrt</h3>
                <p>Please Login With Register Account</p>
